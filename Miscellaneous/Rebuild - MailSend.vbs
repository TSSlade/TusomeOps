...
'http://www.rondebruin.nl/sendmail.htm
    ...
    strbody = "Hi " & Cells(FormulaCell.Row, "C").Value & vbNewLine & vbNewLine & _
              "Your liquidation of the advance you received on " & Cells(FormulaCell.Row, "D") & _
              " for the [" & Cells(FormulaCell.Row, "G").Value & "] event ending " & Cells(FormulaCell.Row, "K") & _
              " is now due. Please submit it today." & _
